...
class worldStateExpression
{
	...
	private function evalLogicalExp(){ // Level 1
		$ret = [];
	...
	private function evalRelationalExp(){ // Level 2
		$ret = [];
	...
	private function evalArethmaticExp(){ // Level 3
		$ret = [];
	...
	private function evalValue(){ // Level 4
