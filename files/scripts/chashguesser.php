...
echo "<pre>";
foreach($pdo->query("SELECT id, contenthash FROM wow_rootfiles LEFT JOIN wow_rootfiles_chashes ON wow_rootfiles.id=wow_rootfiles_chashes.filedataid WHERE filename IS NULL AND type = 'bls' ORDER BY wow_rootfiles.id DESC") as $file){
